...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full  md:h-[770px] md:border-black md:border-b-[6px] border-b-[3px] 
      flex  flex-col items-center justify-between md:p-8 overflow-hidden md:overflow-x-scroll"
      >
        {/* scroll bar    */}
        <div
          className="w-full  md:h-[70px] h-0  md:border-black md:border-[6px] border-[3px] invisible md:visible 
      flex items-center justify-between overflow-hidden  "
        ...
        >
          <div className="flex md:flex-row flex-col md:h-[500px] gap-2 w-full md:w-[120%]">
            <div
              className="md:w-[400px] w-full border-black h-[500px]  border-y-[3px]  md:border-[6px] border-[3px] lg:hover:shadow-lg
                lg:hover:shadow-black lg:hover:-translate-y-[2px] duration-300"
            >
              <div className="w-full h-[70%]  bg-project1 bg-cover bg-no-repeat flex justify-end items-end p-3 md:border-b-[6px] border-b-[3px]  border-black">
                <div className="w-[150px] h-[150px] bg-project12 bg-cover bg-no-repeat border-black border-[3px]  "></div>
              </div>
              <div className="w-full h-[15%] flex items-center justify-between">
                ...
                <div
                  className="h-full w-[20%] bg-yellow flex items-center md:justify-start justify-center border-black md:border-l-[6px] md:border-b-[6px]
            ...
            <div
              className="md:w-[400px] w-full h-[500px] border-black  md:border-[6px] border-[3px] left-20 lg:hover:shadow-lg
                lg:hover:shadow-black lg:hover:-translate-y-[2px] duration-300 "
            >
              <div className="w-full h-[70%] bg-project2 bg-cover bg-no-repeat flex justify-end items-end p-3 md:border-b-[6px] border-b-[3px] border-black">
                <div className="w-[150px] h-[150px] bg-project22 bg-cover bg-no-repeat border-black border-[3px]  "></div>
              </div>
              <div className="w-full h-[15%] flex items-center justify-between">
            ...
            <div
              className="md:w-[400px]  w-full h-[500px] border-black md:border-[6px] border-[3px] left-20 lg:hover:shadow-lg
                lg:hover:shadow-black lg:hover:-translate-y-[2px] duration-300 "
            >
              <div className="w-full h-[70%] bg-project3 bg-cover bg-no-repeat flex justify-end items-end p-3 md:border-b-[6px] border-b-[3px] border-black">
                <div className="w-[150px] h-[150px] bg-project32 bg-cover bg-no-repeat border-black border-[3px]  "></div>
              </div>
              <div className="w-full h-[15%] flex items-center justify-between ">
                ...
                <div
                  className="h-full top-0 w-[20%] bg-yellow flex items-center md:justify-start justify-center  border-black md:border-l-[6px] md:border-b-[6px]
                  border-l-[3px] border-b-[3px]"
                >
            ...
            <div
              className="md:w-[400px] w-full h-[500px] border-black  md:border-[6px] border-[3px] left-20 lg:hover:shadow-lg
                lg:hover:shadow-black lg:hover:-translate-y-[2px] duration-300"
            >
              <div className="w-full h-[70%] bg-project4 bg-cover bg-no-repeat flex justify-end items-end p-3 md:border-b-[6px] border-b-[3px] border-black">
                <div className="w-[150px] h-[150px] bg-project42 bg-cover bg-no-repeat border-black border-[3px]  "></div>
              </div>
              <div className="w-full h-[15%] flex items-center justify-between ">
